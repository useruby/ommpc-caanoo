...
NowPlaying::NowPlaying(mpd_Connection* mpd, SDL_mutex* lock, SDL_Surface* screen, SDL_Surface* bg, Config& config, SDL_Rect& rect, Playlist& pl, artThreadParms_t& artParms)
: m_mpd(mpd)
, m_lock(lock)
, m_screen(screen)
, m_config(config)
